...
class CustomVideoPlayerUpload extends StatefulWidget {
  final String videoUrl;
  const CustomVideoPlayerUpload({super.key, required this.videoUrl});

  @override
  State<CustomVideoPlayerUpload> createState() => _CustomVideoPlayerState();
}

class _CustomVideoPlayerState extends State<CustomVideoPlayerUpload> {
  ...
  @override
  void didUpdateWidget(covariant CustomVideoPlayerUpload oldWidget) {
  ...
  void _openFullscreen() async {
    ...
    // pass current position so fullscreen resumes from same point
    final position = _controller.value.position;
